  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 text-gray-300 text-sm leading-relaxed">
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">1. Virtual Currency Disclaimer</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">2. Not Real Gambling</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">3. Age Requirement</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">4. No Transfer of Virtual Items</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">5. Fair Play</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">6. Responsible Play</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">7. Account Termination</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">8. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-[var(--gold)] mb-3">9. Changes to Terms</h2>
          <p>
