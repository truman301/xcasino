  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-8">
        <span className="text-[var(--gold)]">X</span>Casino Terms of Service
      </h1>
      ...
      <div className="space-y-8 text-gray-300 text-sm leading-relaxed">
        <section>
          ...
          <p>
            XCasino is a <strong className="text-white">free-to-play social casino platform</strong> for entertainment purposes only.
          ...
          <p className="mt-2">
            ...
            within the XCasino platform only.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            XCasino does not offer real-money gambling. No real money can be won or lost through gameplay.
            This platform is not a licensed gambling operator and does not facilitate gambling in any form.
            Playing on XCasino does not constitute gambling under any jurisdiction.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            to use XCasino. By using this platform, you confirm that you meet this age requirement.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Virtual chips and any other virtual items on XCasino are non-transferable. You may not sell, trade, gift,
        ...
        <section>
          ...
          <p>
            All games on XCasino use random number generation for fair outcomes. You agree not to use any automated
            tools, bots, or exploits to manipulate gameplay. XCasino reserves the right to suspend or terminate
        ...
        <section>
          ...
          <p>
            While XCasino does not involve real money, we encourage responsible use of our platform. If you feel
        ...
        <section>
          ...
          <p>
            XCasino reserves the right to terminate or suspend any account at any time, for any reason,
        ...
        <section>
          ...
          <p>
            XCasino is provided &quot;as is&quot; without warranties of any kind. We are not liable for any damages
        ...
        <section>
          ...
          <p>
            We may update these terms at any time. Continued use of XCasino after changes constitutes
